...
namespace Samara
{
    ...
    public class EAshowstopper : Exception
    {
        public EAshowstopper() { }
        public EAshowstopper(string message) : base(message) { }
        public EAshowstopper(string message, Exception inner) : base(message, inner) { }
        protected EAshowstopper(
    ...
    public static class MyExtensions
    {
        ...
        public static List<SelectListItem> MakeYrRq(int FromYr, int ToYr, int SelYr)
        {
            ...
            FromYr = SelYr - FromYr;
            ToYr += SelYr;
            slyr.Add(new SelectListItem { Value = 3999.ToString(), Text = 3999.ToString() });
